...
FLATHUB_DISCORD_APP_VERSION_FALLBACK=c2865f922c0134478a33dc0784092edcb1239c02dcf7a603eeaf3b99420f1fd3
...
FLATPAK_PKGS=(
    ["com.discordapp.Discord"]="${FLATHUB_DISCORD_APP_VERSION:-$FLATHUB_DISCORD_APP_VERSION_FALLBACK}"
